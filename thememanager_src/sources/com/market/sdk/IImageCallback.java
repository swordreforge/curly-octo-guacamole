...
public interface IImageCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImageCallback {
        private static final String DESCRIPTOR = "com.market.sdk.IImageCallback";
        static final int TRANSACTION_onImageLoadFailed = 2;
        static final int TRANSACTION_onImageLoadSuccess = 1;
        ...
        public static IImageCallback asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IImageCallback)) ? new Proxy(iBinder) : (IImageCallback) iInterfaceQueryLocalInterface;
        }
