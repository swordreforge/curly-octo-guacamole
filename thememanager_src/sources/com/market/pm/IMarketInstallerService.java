...
public interface IMarketInstallerService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMarketInstallerService {
        ...
        private static class Proxy implements IMarketInstallerService {
        ...
        public static IMarketInstallerService asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IMarketInstallerService)) ? new Proxy(iBinder) : (IMarketInstallerService) iInterfaceQueryLocalInterface;
        }
