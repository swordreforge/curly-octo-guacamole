...
import com.tencent.mm.opensdk.utils.C5374a;
...
public class PayReq extends BaseReq {
    ...
    public static class Options {
        ...
        public void fromBundle(Bundle bundle) {
            this.callbackClassName = C5374a.m18258b(bundle, "_wxapi_payoptions_callback_classname");
            this.callbackFlags = C5374a.m18257a(bundle, "_wxapi_payoptions_callback_flags");
        }
    ...
    public void fromBundle(Bundle bundle) {
        ...
        this.appId = C5374a.m18258b(bundle, "_wxapi_payreq_appid");
        this.partnerId = C5374a.m18258b(bundle, "_wxapi_payreq_partnerid");
        this.prepayId = C5374a.m18258b(bundle, "_wxapi_payreq_prepayid");
        this.nonceStr = C5374a.m18258b(bundle, "_wxapi_payreq_noncestr");
        this.timeStamp = C5374a.m18258b(bundle, "_wxapi_payreq_timestamp");
        this.packageValue = C5374a.m18258b(bundle, "_wxapi_payreq_packagevalue");
        this.sign = C5374a.m18258b(bundle, "_wxapi_payreq_sign");
        this.extData = C5374a.m18258b(bundle, "_wxapi_payreq_extdata");
        this.signType = C5374a.m18258b(bundle, "_wxapi_payreq_sign_type");
