...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            if (strPathOldToNew != null && strPathOldToNew.length() > 0) {
                try {
                    IMediaObject iMediaObject = (IMediaObject) Class.forName(strPathOldToNew).newInstance();
                    wXMediaMessage.mediaObject = iMediaObject;
                    iMediaObject.unserialize(bundle);
                    return wXMediaMessage;
                } catch (Exception e2) {
                    Log.m18253e(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + strPathOldToNew + ", ex = " + e2.getMessage());
                }
            }
            return wXMediaMessage;
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            Log.m18253e(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }

        private static String pathOldToNew(String str) {
            Log.m18254i(WXMediaMessage.TAG, "pathOldToNew, oldPath = " + str);
            if (str == null || str.length() == 0) {
                Log.m18253e(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
                return str;
            }
            ...
            Log.m18253e(WXMediaMessage.TAG, "pathOldToNew fail, invalid pos, oldPath = " + str);
            return str;
        }
    ...
    public final void setThumbImage(Bitmap bitmap) {
        try {
            ...
            Log.m18253e(TAG, "setThumbImage exception:" + e2.getMessage());
        }
    }
}
