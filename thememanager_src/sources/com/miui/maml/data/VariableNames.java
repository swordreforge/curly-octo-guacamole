...
public class VariableNames {
    ...
    public static final String VAR_DARK_MODE = "__darkmode";
    public static final String VAR_DARK_MODE_WALLPAPER = "__darkmode_wallpaper";
    ...
    public static final String VAR_IS_TABLET = "__is_tablet";
