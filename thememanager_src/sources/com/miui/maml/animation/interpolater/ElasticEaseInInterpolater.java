...
public class ElasticEaseInInterpolater implements Interpolator {
    ...
    public float getInterpolation(float f2) {
        ...
        return -((float) (((double) f3) * Math.pow(2.0d, 10.0f * r10) * Math.sin((((double) ((f2 - 1.0f) - fAsin)) * 6.283185307179586d) / ((double) this.mPriod))));
    }
    ...
    public ElasticEaseInInterpolater(float f2, float f3) {
        this.mPriod = f2;
        this.mAmplitude = f3;
    }
}
