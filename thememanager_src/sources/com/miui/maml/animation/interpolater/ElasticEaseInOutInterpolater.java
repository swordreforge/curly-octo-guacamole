...
public class ElasticEaseInOutInterpolater implements Interpolator {
    ...
    public float getInterpolation(float f2) {
        ...
        if (f4 < 1.0f) {
            return ((float) (((double) f3) * Math.pow(2.0d, 10.0f * r13) * Math.sin((((double) ((f4 - 1.0f) - fAsin)) * 6.283185307179586d) / ((double) this.mPriod)))) * (-0.5f);
        }
        return (float) ((((double) f3) * Math.pow(2.0d, (-10.0f) * r13) * Math.sin((((double) ((f4 - 1.0f) - fAsin)) * 6.283185307179586d) / ((double) this.mPriod)) * 0.5d) + 1.0d);
    }
