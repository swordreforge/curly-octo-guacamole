...
/* JADX INFO: renamed from: com.miui.clock.hct.n */
...
public class C5054n {
    ...
    public static double m17665g(double d2, double d4) {
        return f7l8(d4 - d2) <= 180.0d ? 1.0d : -1.0d;
    }

    /* JADX INFO: renamed from: k */
    public static double m17666k(double d2, double d4, double d5) {
        return d5 < d2 ? d2 : d5 > d4 ? d4 : d5;
    }

    /* JADX INFO: renamed from: n */
    public static double[] m17667n(double[] dArr, double[][] dArr2) {
        double d2 = dArr[0];
    ...
    public static double m17668q(double d2, double d4, double d5) {
        return ((1.0d - d5) * d2) + (d5 * d4);
    }

    /* JADX INFO: renamed from: s */
    public static int m17669s(double d2) {
        if (d2 < 0.0d) {
            return -1;
        }
        return d2 == 0.0d ? 0 : 1;
    ...
    public static int m17670y(int i2) {
        int i3 = i2 % 360;
