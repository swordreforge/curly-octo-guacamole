...
public class C5055q {
    ...
    static int f7l8(double d2, double d4, double d5) {
        ...
        while (i2 < 5) {
            ...
            double d8 = dSqrt;
            double qVar = (f7l8Var.toq() * Math.pow(d6, (1.0d / f7l8Var.zy()) / f7l8Var.ld6())) / f7l8Var.f7l8();
            double d9 = (((0.305d + qVar) * 23.0d) * dPow2) / (((23.0d * dCos) + ((dPow2 * 11.0d) * dCos2)) + ((dPow2 * 108.0d) * dSin));
            double d10 = d9 * dCos2;
            double d11 = d9 * dSin;
            double d12 = qVar * 460.0d;
            double[] dArrM17667n = C5054n.m17667n(new double[]{m17675p((((451.0d * d10) + d12) + (288.0d * d11)) / 1403.0d), m17675p(((d12 - (891.0d * d10)) - (261.0d * d11)) / 1403.0d), m17675p(((d12 - (d10 * 220.0d)) - (d11 * 6300.0d)) / 1403.0d)}, f71865toq);
            double d13 = dArrM17667n[0];
            if (d13 < 0.0d) {
                break;
            }
            double d14 = dArrM17667n[1];
            if (d14 < 0.0d) {
                break;
            }
            double d15 = dArrM17667n[2];
            if (d15 < 0.0d) {
                break;
            }
            double[] dArr = f71866zy;
            ...
            if (dArrM17667n[0] <= 100.01d && dArrM17667n[1] <= 100.01d && dArrM17667n[2] <= 100.01d) {
                return toq.zy(dArrM17667n);
            }
        }
        return 0;
    }
    ...
    static int m17671g(double d2) {
        return (int) Math.floor(d2 - 0.5d);
    }

    /* JADX INFO: renamed from: h */
    static double[] m17672h(double[] dArr, double d2, double[] dArr2, int i2) {
        return x2(dArr, m17677s(dArr[i2], d2, dArr2[i2]), dArr2);
    }

    /* JADX INFO: renamed from: k */
    static boolean m17673k(double d2, double d4, double d5) {
        return kja0(d4 - d2) < kja0(d5 - d2);
    }

    public static int ki(double d2, double d4, double d5) {
        if (d4 < 1.0E-4d || d5 < 1.0E-4d || d5 > 99.9999d) {
            return toq.m17685q(d5);
        }
        double dF7l8 = (C5054n.f7l8(d2) / 180.0d) * 3.141592653589793d;
        double dM17681i = toq.m17681i(d5);
        int iF7l8 = f7l8(dF7l8, d4, dM17681i);
        return iF7l8 != 0 ? iF7l8 : toq.zy(toq(dM17681i, dF7l8));
    }
    ...
    static double m17675p(double d2) {
        double dAbs = Math.abs(d2);
        return ((double) C5054n.m17669s(d2)) * Math.pow(Math.max(0.0d, (27.13d * dAbs) / (400.0d - dAbs)), 2.380952380952381d);
    }

    /* JADX INFO: renamed from: q */
    static double m17676q(double d2) {
        double dPow = Math.pow(Math.abs(d2), 0.42d);
        return ((((double) C5054n.m17669s(d2)) * 400.0d) * dPow) / (dPow + 27.13d);
    }
    ...
    static double m17677s(double d2, double d4, double d5) {
        return (d4 - d2) / (d5 - d2);
    }
    ...
    static double[] toq(double d2, double d4) {
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            ...
            if (d5 != d6) {
                if (d5 < d6) {
                    iM17674n = m17671g(t8r(d5));
                    iM17671g = m17674n(t8r(dArr2[i2]));
                } else {
                    iM17674n = m17674n(t8r(d5));
                    iM17671g = m17671g(t8r(dArr2[i2]));
                }
                int i3 = iM17674n;
                int i4 = iM17671g;
                for (int i5 = 0; i5 < 8 && Math.abs(i4 - i3) > 1; i5++) {
                    int iFloor = (int) Math.floor(((double) (i3 + i4)) / 2.0d);
                    double[] dArrM17672h = m17672h(dArr, f29123q[iFloor], dArr2, i2);
                    double dM17678y2 = m17678y(dArrM17672h);
                    if (m17673k(dM17678y, d4, dM17678y2)) {
                        dArr2 = dArrM17672h;
                        i4 = iFloor;
                    } else {
                        dArr = dArrM17672h;
    ...
    static double m17678y(double[] dArr) {
        double[] dArrM17667n = C5054n.m17667n(dArr, f29122k);
        double dM17676q = m17676q(dArrM17667n[0]);
        double dM17676q2 = m17676q(dArrM17667n[1]);
        double dM17676q3 = m17676q(dArrM17667n[2]);
        return Math.atan2(((dM17676q + dM17676q2) - (dM17676q3 * 2.0d)) / 9.0d, (((dM17676q * 11.0d) + ((-12.0d) * dM17676q2)) + dM17676q3) / 11.0d);
    }
    ...
    static double[][] zy(double d2, double d4) {
        ...
        for (int i2 = 0; i2 < 12; i2++) {
            ...
            if (dArrN7h[0] >= 0.0d) {
                double dM17678y = m17678y(dArrN7h);
                if (!z3) {
                    z3 = true;
                    dArr = dArrN7h;
                    dArr2 = dArr;
                    d5 = dM17678y;
                    d6 = d5;
                } else if (z2 || m17673k(d5, dM17678y, d6)) {
                    if (m17673k(d5, d4, dM17678y)) {
                        z2 = false;
                        dArr2 = dArrN7h;
                        d6 = dM17678y;
                    } else {
