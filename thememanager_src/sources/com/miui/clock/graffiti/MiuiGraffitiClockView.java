...
public class MiuiGraffitiClockView extends ConstraintLayout {
    ...
    private void m17644j() {
        ...
        if (this.as) {
            ...
            ((ViewGroup.MarginLayoutParams) c0392k).width = hb(C5049g.q.f71609ob);
            ((ViewGroup.MarginLayoutParams) c0392k).height = hb(C5049g.q.f71498bqie);
            c0392k.setMargins(hb(C5049g.q.f71527f1bi), hb(C5049g.q.f71636tww7), 0, 0);
            Drawable drawable = getResources().getDrawable(C5049g.n.f71210pnt2);
            drawable.setTint(this.bl.qrj());
            this.bs.setImageDrawable(drawable);
        }
        c0392k2.f2653s = this.ba.getId();
        c0392k2.f2648n = this.ax.getId();
        ((ViewGroup.MarginLayoutParams) c0392k2).width = hb(this.as ? C5049g.q.f71578lk : C5049g.q.f71650vwb);
        ((ViewGroup.MarginLayoutParams) c0392k2).height = hb(this.as ? C5049g.q.f71548hyow : C5049g.q.f71619qh4d);
        c0392k2.setMargins(hb(this.as ? C5049g.q.f71616pnt2 : C5049g.q.f71664xblq), hb(this.as ? C5049g.q.f71590mi1u : C5049g.q.f71666xtb7), 0, 0);
        c0392k3.f2653s = this.ba.getId();
        c0392k3.f2648n = this.ax.getId();
        ((ViewGroup.MarginLayoutParams) c0392k3).width = hb(this.as ? C5049g.q.f71613ovdh : C5049g.q.f71507cn02);
        ((ViewGroup.MarginLayoutParams) c0392k3).height = hb(this.as ? C5049g.q.f71539gb : C5049g.q.f71563kbj);
        c0392k3.setMargins(hb(this.as ? C5049g.q.f71569kq2f : C5049g.q.f71499btvn), hb(this.as ? C5049g.q.f71591mj : C5049g.q.f71665xm), 0, 0);
    ...
    private void m17645m() {
        Constraints.C0392k c0392k = new Constraints.C0392k(0, 0);
        Constraints.C0392k c0392k2 = new Constraints.C0392k(0, 0);
        c0392k.f2653s = this.ba.getId();
        c0392k.f2657y = this.ax.getId();
        ((ViewGroup.MarginLayoutParams) c0392k).width = hb(this.as ? C5049g.q.f71576le7 : C5049g.q.f71612oph);
        ((ViewGroup.MarginLayoutParams) c0392k).height = hb(this.as ? C5049g.q.f71660wwp : C5049g.q.f71642ula6);
        c0392k.setMargins(0, hb(this.as ? C5049g.q.f71568kl7m : C5049g.q.f71490b7), hb(this.as ? C5049g.q.f71628sc : C5049g.q.f71684zuf), 0);
        c0392k2.f2653s = this.ba.getId();
        c0392k2.f2657y = this.ax.getId();
        ((ViewGroup.MarginLayoutParams) c0392k2).width = hb(this.as ? C5049g.q.f71587m8 : C5049g.q.f71643uo);
        ((ViewGroup.MarginLayoutParams) c0392k2).height = hb(this.as ? C5049g.q.f71677z4j7 : C5049g.q.f71649vss1);
        c0392k2.setMargins(0, hb(this.as ? C5049g.q.f71551i1an : C5049g.q.f71511d1ts), hb(this.as ? C5049g.q.f71570kt06 : C5049g.q.f71573kz28), 0);
        this.bq.setLayoutParams(c0392k);
        this.ac.setLayoutParams(c0392k2);
    }

    /* JADX INFO: renamed from: o */
    private void m17646o() {
        Constraints.C0392k c0392k = new Constraints.C0392k(0, 0);
        Constraints.C0392k c0392k2 = new Constraints.C0392k(0, 0);
        Constraints.C0392k c0392k3 = new Constraints.C0392k(0, 0);
        ...
        c0392k.f2653s = this.ba.getId();
        ((ViewGroup.MarginLayoutParams) c0392k).width = hb(C5049g.q.f71658wtop);
        ((ViewGroup.MarginLayoutParams) c0392k).height = hb(C5049g.q.f71679z617);
        c0392k.setMargins(0, hb(C5049g.q.f71668xzl), 0, 0);
        c0392k2.f2657y = this.ax.getId();
        c0392k2.f2653s = this.ba.getId();
        ((ViewGroup.MarginLayoutParams) c0392k2).width = hb(C5049g.q.f71502c25);
        ((ViewGroup.MarginLayoutParams) c0392k2).height = hb(C5049g.q.f71488ab);
        c0392k3.f2648n = this.ad.getId();
        c0392k3.f2653s = this.ba.getId();
        ((ViewGroup.MarginLayoutParams) c0392k3).width = hb(C5049g.q.f71605nyj);
        ((ViewGroup.MarginLayoutParams) c0392k3).height = hb(C5049g.q.f71634tjz5);
        c0392k3.setMargins(hb(C5049g.q.f71528f3f), hb(C5049g.q.f71552i3x9), 0, 0);
