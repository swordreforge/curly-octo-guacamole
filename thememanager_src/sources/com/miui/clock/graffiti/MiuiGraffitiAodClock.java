...
public class MiuiGraffitiAodClock extends MiuiGalleryBaseClock {
    ...
    private MiuiGraffitiAodClockView am;
    private int ay;
    private boolean be;
    private boolean bs;
    ...
    private void y9n() {
        ...
        this.am.setLayoutParams(new ConstraintLayout.toq(-1, -2));
    }
    ...
    protected void onFinishInflate() {
        ...
        this.am = (MiuiGraffitiAodClockView) findViewById(C5049g.g.f71046t8r);
        y9n();
    }
    ...
    public void setClockPalette(int i2, boolean z2, Map<String, Integer> map, boolean z3) {
        ...
        Log.d("MiuiGraffitiAodClock ClockPalette", "setClockPalette: type = " + i2 + ", textDark = " + z2 + ", palette = " + str);
        ...
        if (c5051q != null) {
            ...
            this.ad.gvn7(C6066y.m22346k(iQrj));
