...
public interface IPassportCommonService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPassportCommonService {
        private static final String DESCRIPTOR = "com.xiaomi.passport.IPassportCommonService";
        ...
        private static class Proxy implements IPassportCommonService {
            ...
            public DeviceInfoResult getDeviceInfo(String str, int i2) throws RemoteException {
                ...
                try {
                    ...
                    return parcelObtain2.readInt() != 0 ? DeviceInfoResult.CREATOR.createFromParcel(parcelObtain2) : null;
                } finally {
    ...
    DeviceInfoResult getDeviceInfo(String str, int i2) throws RemoteException;
}
