...
public interface IPreloadAppDetailService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPreloadAppDetailService {
        private static final String DESCRIPTOR = "com.xiaomi.market.IPreloadAppDetailService";
        static final int TRANSACTION_preloadAppDetail = 1;

        private static class Proxy implements IPreloadAppDetailService {
        ...
        public static IPreloadAppDetailService asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IPreloadAppDetailService)) ? new Proxy(iBinder) : (IPreloadAppDetailService) iInterfaceQueryLocalInterface;
        }
