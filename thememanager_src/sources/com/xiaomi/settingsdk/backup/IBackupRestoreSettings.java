...
public interface IBackupRestoreSettings extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBackupRestoreSettings {
        private static final String DESCRIPTOR = "com.xiaomi.settingsdk.backup.IBackupRestoreSettings";
        static final int TRANSACTION_handleSettingsIntent = 1;

        private static class Proxy implements IBackupRestoreSettings {
        ...
        public static IBackupRestoreSettings asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IBackupRestoreSettings)) ? new Proxy(iBinder) : (IBackupRestoreSettings) iInterfaceQueryLocalInterface;
        }
