...
public enum kx3 {
    ...
    GSLB_ERR(10999),
    CONN_SUCCESS(com.android.thememanager.lockscreen.lock.wallpaper.kja0.f60389kja0),
    ...
    CONN_BOSH_ERR(20499),
    BIND_SUCCESS(com.android.thememanager.lockscreen.lock.wallpaper.kja0.f12502h),
    ...
    /* JADX INFO: renamed from: a */
    public static kx3 m21147a(int i2) {
        if (i2 == 30501) {
            return BIND_TIMEOUT;
        }
        if (i2 == 30502) {
        ...
        switch (i2) {
            ...
            default:
                switch (i2) {
                    ...
                    case 10999:
                        return GSLB_ERR;
                    case com.android.thememanager.lockscreen.lock.wallpaper.kja0.f60389kja0 /* 20000 */:
                        return CONN_SUCCESS;
                    case 20199:
                    ...
                    case com.android.thememanager.lockscreen.lock.wallpaper.kja0.f12502h /* 30000 */:
                        return BIND_SUCCESS;
                    case 30199:
                        return BIND_TCP_ERR;
                    case 30399:
