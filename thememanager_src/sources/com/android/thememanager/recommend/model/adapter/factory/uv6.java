...
/* JADX INFO: compiled from: SixGirdBannersElementFactory.java */
/* JADX INFO: loaded from: classes2.dex */
public class uv6 extends qrj {
    ...
    public List<UIElement> mo8509k(UICard card) {
        ...
        if (list != null && list.size() == 6) {
            arrayList.add(new SixGirdBannerElement(card.gridBanners, card.trackId));
        }
        return arrayList;
    }
}
