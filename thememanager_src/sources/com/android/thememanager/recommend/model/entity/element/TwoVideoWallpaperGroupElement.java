...
public class TwoVideoWallpaperGroupElement extends UIElement {
    private List<UIProduct> originProducts;
    private List<UIProduct> products;
    private String subjectUuid;

    public TwoVideoWallpaperGroupElement(List<UIProduct> originProducts, String subjectUuid, List<UIProduct> products) {
        super(65);
