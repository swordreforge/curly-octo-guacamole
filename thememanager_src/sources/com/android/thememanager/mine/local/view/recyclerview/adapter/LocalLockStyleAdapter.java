...
public class LocalLockStyleAdapter extends LocalThemeAdapter {
    public LocalLockStyleAdapter(@lvui InterfaceC1719p viewContainer, String resourceCode, InterfaceC6058k.k presenter) {
    ...
    public BatchOperationAdapter.BatchViewHolder<BaseLocalResourceAdapter.toq> onCreateViewHolder(@lvui ViewGroup viewGroup, int i2) {
        return LocalLockStyleViewHolder.m8257f(viewGroup, this);
    }
    ...
    protected boolean gyi(Resource resource, C1791k resourceContext) {
        return C1792n.d3(resource) || C1792n.gvn7(resource) ? !C2320q.o1t(toq.toq(), "splockscreen").contains(resource.getLocalId()) : super.gyi(resource, resourceContext);
    }
}
