...
import com.android.thememanager.mine.local.view.recyclerview.viewholder.LocalMiWallpaperViewHolder;
import gbni.InterfaceC6058k;
import zy.lvui;

/* JADX INFO: loaded from: classes2.dex */
public class LocalMiWallpaperAdapter extends BaseLocalResourceAdapter {
    public LocalMiWallpaperAdapter(@lvui InterfaceC1719p viewContainer, String resourceCode, InterfaceC6058k.k presenter) {
    ...
    public BatchOperationAdapter.BatchViewHolder<BaseLocalResourceAdapter.toq> onCreateViewHolder(@lvui ViewGroup viewGroup, int i2) {
        return LocalMiWallpaperViewHolder.m8258l(viewGroup, this);
    }
}
