...
public class toq extends f7l8<Integer> {
    public toq(List<C1515k<Integer>> list) {
        super(list);
    }
     ...
     */
    public int cdj(C1515k<Integer> c1515k, float f2) {
        Integer num;
        if (c1515k.f56198toq == null || c1515k.f56200zy == null) {
            throw new IllegalStateException("Missing values for keyframe.");
        }
        C1517p<A> c1517p = this.f7893n;
        return (c1517p == 0 || (num = (Integer) c1517p.toq(c1515k.f56193f7l8, c1515k.f8306y.floatValue(), c1515k.f56198toq, c1515k.f56200zy, f2, m5923n(), m5921g())) == null) ? com.airbnb.lottie.utils.toq.zy(com.airbnb.lottie.utils.f7l8.zy(f2, 0.0f, 1.0f), c1515k.f56198toq.intValue(), c1515k.f56200zy.intValue()) : num.intValue();
    }
