...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private static class MediaControllerCallbackApi21 extends MediaController.Callback {
            ...
            public void onAudioInfoChanged(MediaController.PlaybackInfo info) {
                ...
                if (callback != null) {
                    callback.onAudioInfoChanged(new PlaybackInfo(info.getPlaybackType(), AudioAttributesCompat.m4545n(info.getAudioAttributes()), info.getVolumeControl(), info.getMaxVolume(), info.getCurrentVolume()));
                }
            }
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        private static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            protected void onReceiveResult(int resultCode, Bundle resultData) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(C0432h.m1886k(resultData, MediaSessionCompat.KEY_EXTRA_BINDER)));
                    mediaControllerImplApi21.mSessionToken.setSession2Token(androidx.versionedparcelable.zy.zy(resultData, MediaSessionCompat.KEY_SESSION2_TOKEN));
        ...
        static void setMediaController(@lvui Activity activity, @dd MediaControllerCompat mediaControllerCompat) {
        ...
        public PlaybackInfo getPlaybackInfo() {
            ...
            if (playbackInfo != null) {
                return new PlaybackInfo(playbackInfo.getPlaybackType(), AudioAttributesCompat.m4545n(playbackInfo.getAudioAttributes()), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume());
            }
            return null;
        }
        ...
        @dd
        static MediaControllerCompat getMediaController(@lvui Activity activity) {
    ...
    public static final class PlaybackInfo {
        ...
        PlaybackInfo(int type, int stream, int control, int max, int current) {
            this(type, new AudioAttributesCompat.C0964q().m4550q(stream).m4548k(), control, max, current);
        }
        ...
        public int getAudioStream() {
            return this.mAudioAttrsCompat.qrj();
        }
        ...
        PlaybackInfo(int type, @lvui AudioAttributesCompat attrsCompat, int control, int max, int current) {
    ...
    public MediaControllerCompat(Context context, @lvui MediaSessionCompat session) {
        if (session == null) {
    ...
    public static MediaControllerCompat getMediaController(@lvui Activity activity) {
        Object tag = activity.getWindow().getDecorView().getTag(x2.toq.f51750ld6);
    ...
    public static void setMediaController(@lvui Activity activity, MediaControllerCompat mediaController) {
        activity.getWindow().getDecorView().setTag(x2.toq.f51750ld6, mediaController);
    ...
    public void registerCallback(@lvui Callback callback) {
    ...
    public void sendCommand(@lvui String command, @dd Bundle params, @dd ResultReceiver cb) {
    ...
    public void unregisterCallback(@lvui Callback callback) {
        if (callback == null) {
    ...
    public void registerCallback(@lvui Callback callback, Handler handler) {
        if (callback == null) {
            throw new IllegalArgumentException("callback must not be null");
        }
    ...
    public MediaControllerCompat(Context context, @lvui MediaSessionCompat.Token sessionToken) {
