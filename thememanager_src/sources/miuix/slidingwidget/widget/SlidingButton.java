...
public class SlidingButton extends AppCompatCheckBox {
    ...
    public void onMeasure(int i2, int i3) {
        setMeasuredDimension(this.f41610y.cdj(), this.f41610y.m26569h());
        this.f41610y.m26571l();
    }
    ...
    protected boolean verifyDrawable(Drawable drawable) {
        toq toqVar;
        return super.verifyDrawable(drawable) || ((toqVar = this.f41610y) != null && toqVar.lrht(drawable));
    }
    ...
    public SlidingButton(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f41610y.fu4(context, typedArrayObtainStyledAttributes);
