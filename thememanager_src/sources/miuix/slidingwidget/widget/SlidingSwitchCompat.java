...
public class SlidingSwitchCompat extends SwitchCompat {
    ...
    public void onMeasure(int i2, int i3) {
        setMeasuredDimension(this.tlhn.cdj(), this.tlhn.m26569h());
        this.tlhn.m26571l();
    }
    ...
    protected boolean verifyDrawable(Drawable drawable) {
        toq toqVar;
        return super.verifyDrawable(drawable) || ((toqVar = this.tlhn) != null && toqVar.lrht(drawable));
    }
    ...
    public SlidingSwitchCompat(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.tlhn.fu4(context, typedArrayObtainStyledAttributes);
