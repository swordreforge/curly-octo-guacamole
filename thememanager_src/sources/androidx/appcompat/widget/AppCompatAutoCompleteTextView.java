...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements InterfaceC0704l, lvui {

    /* JADX INFO: renamed from: g */
    private static final int[] f717g = {R.attr.popupBackground};

    /* JADX INFO: renamed from: k */
    private final C0206n f718k;

    /* JADX INFO: renamed from: n */
    @zy.lvui
    private final qrj f719n;

    /* JADX INFO: renamed from: q */
    private final C0220t f720q;

    public AppCompatAutoCompleteTextView(@zy.lvui Context context) {
        this(context, null);
    }
    ...
    protected void drawableStateChanged() {
        ...
        C0206n c0206n = this.f718k;
        if (c0206n != null) {
            c0206n.toq();
        }
        C0220t c0220t = this.f720q;
        if (c0220t != null) {
            c0220t.toq();
        }
    }
    ...
    public boolean mo447n() {
        return this.f719n.zy();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f719n.m709n(kja0.m626k(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(@zy.dd KeyListener keyListener) {
        super.setKeyListener(this.f719n.m708k(keyListener));
    }
    ...
    public AppCompatAutoCompleteTextView(@zy.lvui Context context, @zy.dd AttributeSet attributeSet) {
        this(context, attributeSet, C7397k.toq.f92921n5r1);
    }

    public AppCompatAutoCompleteTextView(@zy.lvui Context context, @zy.dd AttributeSet attributeSet, int i2) {
        super(ek5k.toq(context), attributeSet, i2);
        C0214o.m692k(this, getContext());
        C0184b c0184bJp0y = C0184b.jp0y(getContext(), attributeSet, f717g, i2, 0);
        if (c0184bJp0y.mcp(0)) {
