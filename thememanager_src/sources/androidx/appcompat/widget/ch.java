...
public class ch extends uv6 {

    /* JADX INFO: renamed from: q */
    public static final int f976q = 20;

    /* JADX INFO: renamed from: zy, reason: collision with root package name */
    private static boolean f46852zy = false;

    /* JADX INFO: renamed from: toq, reason: collision with root package name */
    private final WeakReference<Context> f46853toq;

    public ch(@zy.lvui Context context, @zy.lvui Resources resources) {
        super(resources);
        this.f46853toq = new WeakReference<>(context);
    }

    /* JADX INFO: renamed from: q */
    public static boolean m570q() {
        toq();
        return false;
    }
    ...
    public Drawable getDrawable(int i2) throws Resources.NotFoundException {
        Context context = this.f46853toq.get();
        return context != null ? lrht.m648y().m649i(context, this, i2) : m729k(i2);
    }
