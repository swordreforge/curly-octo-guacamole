...
public final class CompositePageTransformer implements ViewPager2.PageTransformer {
    ...
    public void addTransformer(@lvui ViewPager2.PageTransformer pageTransformer) {
        this.mTransformers.add(pageTransformer);
    }

    public void removeTransformer(@lvui ViewPager2.PageTransformer pageTransformer) {
